(function (exports, Laya) {
	...
	class ScrollBar extends UIComponent {
	    ...
	    loop() {
	        ...
	        if (this._clickOnly) {
	            if (Math.abs(this._lastOffset * (this.isVertical ? Laya.ILaya.stage._canvasTransform.getScaleY() : Laya.ILaya.stage._canvasTransform.getScaleX())) > 2) {
	...
	class List extends Box {
	    ...
	    createItem() {
			...
			if(this.__onCreateItem) this.__onCreateItem(box);
